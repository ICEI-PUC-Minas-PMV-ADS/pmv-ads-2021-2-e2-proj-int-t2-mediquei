...
namespace app_web_backend_Mediquei.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Senha,EMail,EMailRecuperar,Perfil")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Senha,EMail,EMailRecuperar,Perfil")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
