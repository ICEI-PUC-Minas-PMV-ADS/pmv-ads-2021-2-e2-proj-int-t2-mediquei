...
|RNF-07 |O website deve armazenar as informações em um banco de dados.	|Alta|
|RNF-08	|O website deve conter uma barra de navegação de fácil uso.	|Média|
|RNF-09 |O website deve ser de fácil compreensão e utilização. |Alta| 
