...
|Resultados obtidos | Requisito atendido  - Foi possivel acessar o site com sucesso, a tela de login está estável e uniforme, a tela de cadastro segue o mesmo padrão da tela de login, mantendo a padronização. A tela de ajuda é fácil de ser acessada por meio de um link na parte inferior da tela |
